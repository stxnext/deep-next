...
You can override the log level by setting the `LOG_LEVEL` environment variable in your `.env` file or environment:
...
Supported log levels: `TRACE`, `DEBUG`, `INFO`, `SUCCESS`, `WARNING`, `ERROR`, `CRITICAL`.
